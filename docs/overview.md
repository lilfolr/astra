Project Context: Astra (Starship Home)
...
Frontend: Flutter + Flame Engine (for the interactive 2D ship map).

State Management: Riverpod (to sync real-time state across multiple family devices).
