...
*   **Game Engine:** Flame Engine (For the interactive 2D ship/home map).
*   **State Management:** Riverpod (Real-time synchronization).
*   **Backend:** Firebase
...
2.  **Immersive UI:** Use of the Flame engine for the ship map is central to the experience.
